...
def main():
    ...
    while run:
        run_game(steve_run, _steve_view, _steve_controller)


def run_game(steve_run, _steve_view, _steve_controller):
    '''
    Runs 1 game of Steve Run.
    '''
...
steve_run_initial = SteveRun()
menu(caught_count = 0, steve_run = steve_run_initial)
